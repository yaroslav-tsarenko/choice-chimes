      ...
      <main className="terms-content">
        ...
        <div className="definitions-parent">
          ...
          <div className="frame-div">
            <div className="gift-card-parent">
        ...
        <div className="use-of-gift-cards-parent">
          ...
          <div className="frame-parent2">
            <div className="redemption-parent">
            ...
            <div className="non-transferable-parent">
            ...
            <div className="no-cash-redemption-parent">
            ...
            <div className="expiration-parent">
        ...
        <FrameComponent
          generalRefundPolicy="Lost or Stolen Gift Cards"
          generalRefundPolicy1="5.1 Responsibility"
          giftCardsPurchasedFromYou="[Your Company] is not responsible for lost or stolen gift cards. Lost or stolen cards will not be replaced or refunded. Users should treat their gift cards like cash and take appropriate measures to safeguard them."
          exceptions="5.2 Safeguarding"
          inCertainExceptionalCircu="Users should keep their gift cards in a safe place and not share the card number or security code with anyone. If a gift card is lost or stolen, users should report it immediately to customer support, although replacement or refund cannot be guaranteed."
        />
        <FrameComponent
          generalRefundPolicy="Refunds and Returns"
          generalRefundPolicy1="6.1 No Cash Refunds"
          giftCardsPurchasedFromYou="Gift cards cannot be returned or exchanged for cash, except as required by law. Once purchased, all sales of gift cards are final. Users should ensure that they understand this policy before making a purchase."
          exceptions="6.2 Merchant Returns"
          inCertainExceptionalCircu="If a product purchased with a gift card is returned, the return will be processed according to the return policy of the merchant where the purchase was made. Users should contact the merchant directly for any issues related to returns and exchanges."
        />
        <FrameComponent
          generalRefundPolicy="User Responsibilities"
          generalRefundPolicy1="7.1 Compliance"
          giftCardsPurchasedFromYou="Users must use the gift cards and website in compliance with all applicable laws and regulations. Any use of the gift cards or website that violates these terms and conditions or any applicable law is strictly prohibited."
          exceptions="7.2 Prohibited Uses"
        ...
        />
        <FrameComponent
          generalRefundPolicy="Privacy"
          generalRefundPolicy1="8.1 Data Collection"
          giftCardsPurchasedFromYou="[Your Company] is committed to protecting your privacy. Our [Privacy Policy] outlines how we collect, use, and protect your personal information. By using our website and purchasing our gift cards, you consent to the collection and use of your information as outlined in our [Privacy Policy]."
          exceptions="8.2 Consent"
          inCertainExceptionalCircu="By using our website and purchasing our gift cards, you consent to the collection and use of your information as outlined in our [Privacy Policy]. If you do not agree with our Privacy Policy, you should not use our website or purchase our gift cards."
        />
        <FrameComponent
          generalRefundPolicy="Limitation of Liability"
          generalRefundPolicy1="9.1 Indirect Damages"
          giftCardsPurchasedFromYou="[Your Company] is not responsible for any indirect, incidental, or consequential damages arising from the use or inability to use the gift cards or website. This includes, but is not limited to, damages for loss of profits, business interruption, or loss of data."
          exceptions="9.2 Maximum Liability"
          inCertainExceptionalCircu="[Your Company]'s liability for any claim related to the purchase or use of a gift card is limited to the amount of the gift card. In no event shall [Your Company]'s total liability to you for all damages, losses, and causes of action exceed the amount paid by you for the gift card."
        />
        <FrameComponent
          generalRefundPolicy="Amendments"
          generalRefundPolicy1="10.1 Right to Amend"
          giftCardsPurchasedFromYou="[Your Company] reserves the right to amend these terms and conditions at any time. Any changes will be posted on this page and will take effect immediately upon posting. Users should review these terms and conditions periodically to ensure that they are aware of any changes."
          exceptions="10.2 User Responsibility"
        ...
        <div className="contact-information-parent">
          ...
          <div className="if-you-have-any-questions-abou-wrapper">
            <div className="if-you-have-container1">
              ...
              <p className="brandname-customer-support1">{`BrandName, Customer Support `}</p>
              <p className="email-supportbrandnamecom1">{`Email: support@brandname.com `}</p>
        ...
        <div className="footer7">
          <div className="footer-links2">
            <div className="footer-links-container">
              ...
              <div className="sister-site-links">
